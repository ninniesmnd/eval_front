    ...
    <div className="bg-white  sm:py-10">
      <div className="mx-auto text-center ">
        <h2 className="text-center text-lg font-semibold leading-8 text-gray-900">
          Empresas que confían en nosotros. Obviamente
        </h2>
        <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          <img
            ...
            src="front_despacho\src\assets\images\a.png"
            alt="Transistor"
            width="158"
            height="48"
          />
          ...
          <img
            className="col-span-2 max-h-12 w-full object-contain lg:col-span-1 mx-auto"
            src="front_despacho\src\assets\images\h.png"
            alt="Tuple"
            width="158"
            height="48"
          />
          <img
            ...
            src="front_despacho\src\assets\images\l.png"
            alt="SavvyCal"
            width="158"
            height="48"
          />
